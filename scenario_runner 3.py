...
CARLA_EGG_PATH = "/home/rm/Desktop/carla15/PythonAPI/carla/dist/carla-0.9.15-py3.10-linux-x86_64.egg" 
if CARLA_EGG_PATH not in sys.path:sys.path.append(CARLA_EGG_PATH)
import carla
